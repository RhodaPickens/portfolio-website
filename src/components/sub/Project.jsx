...
const Project = ({data, index}) => {
  ...
  return (
    <motion.div 
      ...
      className='relative w-[350px] sm:w-full h-max border border-yellow-900 rounded-lg cursor-pointer'>
        <Image 
          src={data.url}
          alt="Project Image"
          width={400}
        ...
        <motion.div 
          ...
          items-center justify-center gap-y-2 bg-white/95 p-6 rounded-lg'>
